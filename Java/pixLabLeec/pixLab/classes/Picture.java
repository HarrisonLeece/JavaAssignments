...
public class Picture extends SimplePicture 
{
  ...
  /* Makes the negative of the picture provided */
  public void negate()
  {
    Pixel[][] pixels = this.getPixels2D();
    for (Pixel[] rowArray : pixels)
  ...
  {
    Picture flower1 = new Picture("rafs.jpg");
    Picture flower2 = new Picture("rafs.jpg");
  ...
  {
    Picture flower1 = new Picture("thumbsUpm8.jpg");
    Picture flower2 = new Picture("haHaHa.png");
    Picture flowerGrey = new Picture("thumbsUpm8.jpg");
    flowerGrey.grayScale();
    Picture flowerNegate = new Picture(flower2);
    Picture flowerFlip = new Picture(flower1);
    this.copy(flowerGrey,0,0);
    flowerFlip.mirrorVertical();
    flowerNegate.negate();
    this.copy(flowerNegate,200,0);
    this.copy(flowerFlip,300,600);
    this.write("collage.jpg");
  }
